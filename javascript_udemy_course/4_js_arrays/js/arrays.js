...
console.log(depts);  // [R&D, Hr, Fi]

// arr.slece(start, stop);
...
var conversion = convertToArray('X', 'Y', 'Z');
console.log(conversion);  // ['X', 'Y', 'Z']
...
// var results = gadgets.find(isMi);
// var result = gadgets.find(mobile => mobile.name === 'Mi');
// console.log(results);  // {name: 'Mi', quantity: 7}
...
// console.log(result);  // [1, 16, 18, 256]
...
// var refomattedArray = keyValueArray.map(formatObj);
// console.log(refomattedArray);  // [{5: 100}, {6: 200}, {7: 300}]
...
// var depts = ['Salees', 'IT', 'R&D', 'Management'];
// depts.sort();
// console.log(depts);  // [, 'I'Management'T', 'R&D', 'Salees']

// var deptsNumbers = [100, 30, 20, 60];

// deptsNumbers.sort(function(a, b) {
// 	return a - b;
// });
// console.log('Asc: ' + deptsNumbers); // Asc: 20, 30, 60, 100

// deptsNumbers.sort(function(a, b) {
// 	return b - a;
// });
// console.log('Desc: ' + deptsNumbers); // Desc: 100, 60, 30, 20,
